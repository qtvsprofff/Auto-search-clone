...
PICS = (environ.get('PICS', 'https://graph.org/file/7a5b5dd0f794f6f81f046.jpg')).split() #SAMPLE PIC
...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '1044163529 885675538').split()]
auth_channel = environ.get('AUTH_CHANNEL','-1001697911445')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001697911445')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001559168301')
